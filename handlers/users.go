...
func Signup(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusOK).JSON(fiber.Map{"status": "success", "data": fiber.Map{"user": model.FilterUserRecord(user)}})
}
...
func Login(c *fiber.Ctx) error {
	...
	return c.Status(fiber.StatusOK).JSON(fiber.Map{"status": "success", "token": tokenString, "user": model.FilterUserRecord(res)})
}
...
func ChangePassword(c *fiber.Ctx) error {
	...
	updatePassword := new(model.ChangePasswordRequest)
